...
class __TwigTemplate_91a999ff466c11587c1d46b31565b44f9a420da9a16b4bf0ea3fcecda5460eaf extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["value"]) {
            // line 8
            echo "        <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("categoryChoose", ["categoryName" => twig_get_attribute($this->env, $this->source, $context["value"], "name", [], "any", false, false, false, 8), "id" => twig_get_attribute($this->env, $this->source, $context["value"], "id", [], "any", false, false, false, 8), "page" => 0]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["value"], "name", [], "any", false, false, false, 8), "html", null, true);
            echo "</a> <br>
    ";
        }
...
{% block title %}Choose a quiz{% endblock %}

{% block body %}
    <h1>Choose a quiz :</h1>
    {% for value in category %}
        <a href=\"{{ path('categoryChoose', {'categoryName': value.name, 'id': value.id, 'page': 0}) }}\">{{ value.name }}</a> <br>
    {% endfor %}
{% endblock %}
", "quiz/index.html.twig", "/home/thib/Epitech/Projets/Quiz/local/quiz/templates/quiz/index.html.twig");
    }
}
